            ...
            <header id="branding" role="banner">
                ...
                <nav id="access" role="navigation">
                    ...
                    <li id="menu-item-147" class="menu-item menu-item-type-post_type menu-item-object-page <?php if($page=='index'){echo 'current-menu-item';} ?> menu-item-home menu-item-147">
                            ...
                            <li id="menu-item-151" class="menu-item menu-item-type-custom menu-item-object-custom <?php if($page=='new'){echo 'current-menu-item';} ?> menu-item-151"><a href="/admin.php?page=new">new</a></li>
                        </ul></div>        
                </nav><!-- #access -->
